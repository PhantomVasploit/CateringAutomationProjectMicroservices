...
const ChefRegister = ()=>{
  const {chefRegisterSubmit} = useContext(UserAuthContext);
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 offset-3 float-md-center">
              <Form className="needs-validation">
                <fieldset className="form-group">
                  ...
                  <legend className="border-bottom mb-4 text-center mt-4">Chef's Sign Up</legend>
