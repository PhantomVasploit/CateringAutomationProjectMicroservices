...
const StockManagerRegister = ()=>{
  const {stockManagerRegisterSubmit} = useContext(UserAuthContext);
  ...
  return(
    ...
    onSubmit = {stockManagerRegisterSubmit}
    >
      {
        formik=>(
...
export default StockManagerRegister;
