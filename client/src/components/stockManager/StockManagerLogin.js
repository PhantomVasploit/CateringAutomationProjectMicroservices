...
const StockManagerLogin = ()=>{
  const {stockManagerLoginSubmit, error} = useContext(UserAuthContext);
    ...
    <div>
      {
        ...
        ?
            ...
            onSubmit = {stockManagerLoginSubmit}
            >
              {
                formik=>(
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 offset-3 float-md-center mt-5">
                      <Form>
                        <fieldset className="form-group">
                          ...
                          <legend className="border-bottom mb-4 text-center mt-4">Stock Manager's Sign In</legend>
