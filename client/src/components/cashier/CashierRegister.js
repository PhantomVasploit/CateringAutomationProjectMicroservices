...
const CashierRegister = ()=>{
  const {cashierRegisterSubmit} = useContext(UserAuthContext);
  ...
  return(
    ...
    onSubmit = {cashierRegisterSubmit}
    >
      {
        formik=>(
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 offset-3 float-md-center">
              <Form className="needs-validation">
                <fieldset className="form-group">
                  ...
                  <legend className="border-bottom mb-4 text-center mt-4">Cashier's Sign Up</legend>
